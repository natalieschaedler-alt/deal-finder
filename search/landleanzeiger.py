...
class LandleanzeigerSearch:
    BASE_URL = "https://www.landleanzeiger.de/suche"

    def search(self, product: Product) -> List[Deal]:
        print(f"Suche nach {product.name} auf Landleanzeiger...")
        search_url = f"{self.BASE_URL}?q={quote_plus(product.name)}"
        ...
        for card in cards[:10]:
            ...
            link = urljoin("https://www.landleanzeiger.de", href)
            ...
            mapped = build_compliant_offer(
                ...
                source_platform="Landleanzeiger",
