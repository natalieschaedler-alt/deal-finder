...
class ShpockSearch:
    BASE_URL = "https://www.shpock.com/de-de/search"

    def search(self, product: Product) -> List[Deal]:
        print(f"Suche nach {product.name} auf Shpock...")
        search_url = f"{self.BASE_URL}?query={quote_plus(product.name)}"
        ...
        for card in cards[:10]:
            ...
            link = urljoin("https://www.shpock.com", href)
